  ...
  return (
    <div>
      <div className="absolute left-4 bottom-14 w-80 z-50 rounded-xl bg-slate-400">
        <div className="text-base font-semibold p-2 m-1 w-full">
        ...
        <div className="w-full flex justify-center items-center flex-row mb-14">
          <button
            onClick={() => handleClick("GJ 687 b")}
            className="border rounded-xl m-2 p-2 text-sm"
          >
            Habitable Example
          </button>
          <button
            onClick={() => handleClick("AB Aur b")}
            className="border rounded-xl m-2 p-2 text-sm"
          >
            Corona Example
          </button>
        ...
        <ul className="bg-opacity-30 overflow-y-scroll max-h-52 scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-transparent scroll-pt-12 mb-3">
